...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_computervision_0935;
            let db_auth = result.data.DB_AUTH_computervision_0935;
            let db_coll = result.data.DB_COLL_computervision_0935;
